...
public class WeChatApiUtil {
	...
	public static void main(String[] args) throws Exception {
		// 媒体文件路径
//		String filePath = "F:/Myeclipse/WxProject/src/me/gacl/wx/web/media/image/123.jpg";
		// String filePath =
		// "D:/JavaSoftwareDevelopeFolder/IntelliJ IDEA_Workspace/WxStudy/web/media/voice/voice.mp3";
		 String filePath =  "F:/Myeclipse/WxProject/src/me/gacl/wx/web/media/video/111.mp4";
		// 媒体文件类型
//		String type = "image";
		// String type = "voice";
		 String type = "video";
